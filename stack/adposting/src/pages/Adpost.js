                      ...
                      <form id="contact-form" role="form" onSubmit={handleSubmit}>
                        ...
                        <div className="row">
                          <div className="col-md-12 mb-3">
                            <label htmlFor="form_need" className="form-label">Please Select Your Ad Category</label>
                            <select
                              id="form_need"
                              name="adCategory"
                              value={adCategory}
                        ...
                        <div className="mb-4"><Link to="/">
                          <button className="btn btn-lg btn-block" type="submit" style={{ backgroundColor: 'purple', color: 'white' }}>Post Ads</button></Link>
                        </div>
